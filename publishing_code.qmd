...
emm_globio <- extract_emm(large_model_1, "GLOBIO",         "GLOBIO",               sectors_to_plot)
emm_lci    <- extract_emm(large_model_1, "LC_Impact",      "LC-Impact",            sectors_to_plot)
emm_direct <- extract_emm(large_model_1, "vc_direct_only", "Direct impacts\nonly", sectors_to_plot)
...
# Save as .tex
print(fixef_df_xt, 
      file = "regression_results_table/large_model_1_summary.tex",
...
# Supplementary Figure 2: Full regression interactions by GICS sector
ggsave(
